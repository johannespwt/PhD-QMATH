...
L^n(\bar{k}^N)\geq2\pi\left[R-\frac{(2R^2-y^2+2\alpha)}{4\abs{y}}\ln\left(\frac{R(R+\abs{y})+\alpha}{R(R-\abs{y})+\alpha}\right)\right],
\end{equation}
So for $ \abs{y}>2R $ we have \begin{equation}
L^n(\bar{k}^N)\geq2\pi\left[R-\frac{(2R^2-y^2+2\alpha)}{4\abs{y}}\frac{2R\abs{y}}{R^2-R\abs{y}+\alpha}\right]\geq2\pi\left[R-\frac{4R\abs{y}}{4\abs{y}}\right].
\end{equation}
