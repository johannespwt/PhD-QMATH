...
%		
	...
	\begin{lemma}
		Let $ T^n_{\text{diag/off}} $ be defined as above. Then for each $ n\geq1 $, we have that $  T^n_{\text{diag}}+T^n_{\text{diag}}  $ is closed/closable and bounded from below.
	\end{lemma}
	\begin{proof}
		Needs proof
	\end{proof}
