...
\begin{document}
	...
	\begin{aligned}
	\Psi_f(x)=\sqrt{\frac{2}{L}}^N\left(\frac{1}{2i}\right)^N\prod_{i=1}^{N}(z_i-z_i^{-1})\prod_{i<j}^{N}\left((z_i+z_i^{-1})-(z_j+z_j^{-1})\right)\\
	2^{\binom{N}{2}}\sqrt{\frac{2}{L}}^N\prod_{i=1}^{N}\sin\left(\frac{\pi}{L}x_i\right)\prod_{i<j}^{N}\left[\cos\left(\frac{\pi}{L}x_i\right)-\cos\left(\frac{\pi}{L}x_j\right)\right]
	\end{aligned}
	\end{equation}
\end{document}