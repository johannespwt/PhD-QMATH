...
\begin{proof}
	...
	\begin{aligned}
	\int\diff \bar{k}^N\abs{\frac{1}{4\pi n}L^n(\bar{k}^N)\xi(\bar{k}^N)}^2&\leq \frac{C}{4\pi n}\int_{\abs{\bar{k}^N}<n}\diff\bar{k}^N L(\bar{k}^N)\abs{\xi(\bar{k}^N)}^2+\int_{\abs{\bar{k}^N}>n}\abs{\xi(\bar{k}^N)}^2
