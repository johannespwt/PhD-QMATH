...
\end{equation}
We will henceforth assume $ \chi=\ket{\text{GS}_{\text{HAF}}} $, \ie the ground state of the \emph{periodic} Heisenberg antiferromagnet.
...
(\tilde{\Psi}_\chi)_{12}\coloneqq \frac{\Psi_F}{x_2-x_1}\left(\omega^{12}_e P_s^{1,2}+\omega_o^{12}P_t^{1,2}\right)\chi,
\end{equation}
...
\begin{aligned}
\int_{B_{12}^{\geq}}\abs{\partial_i\Psi_{\chi}}^2\leq&\int_{A_{12}}\abs{\partial_i(\Psi_e)_{12}}^2\frac{1}{N}\sum_k\braket{\chi \left\lvert P^{k,k+1}_s  \right\rvert \chi}\\
&+\int_{A_{12}}\abs{\partial_i(\Psi_o)_{12}}^2\frac{1}{N}\sum_k\braket{\chi \left\lvert P^{k,k+1}_t  \right\rvert \chi}.
\end{aligned}
\end{equation}
...
\int_{B_{12}^{\geq}}\abs{\partial_i\Psi_{\chi}}^2\leq \int_{A_{12}}\abs{\partial_i(\Psi_e)_{12}}^2\frac{1}{N}\sum_k\braket{\chi \left\lvert P^{k,k+1}_s  \right\rvert \chi}+\abs{\partial_i(\Psi_o)_{12}}^2\frac{1}{N}\sum_k\braket{\chi \left\lvert P^{k,k+1}_t  \right\rvert \chi}
\end{equation}
