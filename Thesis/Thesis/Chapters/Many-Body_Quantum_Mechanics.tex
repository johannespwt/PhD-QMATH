...
$$
are satisfied if for $ P=(p_1,p_2,\ldots,p_j=q,p_{j+1}=p,\ldots,p_N) $ and $ Q=(p_1,p_2,\ldots,q_j=p,q_{j+1}=q,\ldots,p_N) $, we have $ i(p-q)(a(P)-a(Q))=c (a(P)+a(Q)) $ implying $ a(Q)=-\frac{c-i(p-q)}{c+i(p-q)}a(P):=-\exp(i\theta_{j,j+1}) $.....
